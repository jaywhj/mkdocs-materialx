...
it can be difficult to work with them. MaterialX for MkDocs makes working with
...
with MaterialX for MkDocs. Install it with `pip`:
...
??? question "Why is there no centered alignment?"
    ...
    is why this option is not supported by MaterialX for MkDocs.[^1] Instead,
  ...
  [^1]:
    ...
    is viewed outside of a website generated by MaterialX for MkDocs.
